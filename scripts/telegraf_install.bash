...
sudo apt-get update && sudo apt-get install -y hddtemp lm-sensors telegraf

echo "[INFO] getting config file"
sudo wget -qO- https://raw.githubusercontent.com/Wilply/compose-files/master/04_grafana/telegraf.conf | sudo tee "/etc/telegraf/telegraf.conf"
